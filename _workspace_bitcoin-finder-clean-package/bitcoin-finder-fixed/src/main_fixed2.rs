...
impl CheckpointManager {
    ...
    fn save_checkpoint(
        ...
        let checkpoint_data = CheckpointData {
            ...
            high_score_mnemonics: limited_high_scores,
            word_frequencies: self.limit_map_size(word_freqs, 1000),
            word_pair_frequencies: self.limit_map_size(word_pair_freqs, 1000),
            word_position_frequencies: self.limit_map_size(word_position_freqs, 500),
            pattern_frequencies: self.limit_map_size(pattern_freqs, 500),
        };
...
fn main() {
    ...
    thread::spawn(move || {
        ...
        loop {
            ...
            let (mnemonics, addresses, _) = stats_clone.get_counts();
